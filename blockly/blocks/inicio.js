...
Blockly.Blocks['bloque_cancion'] = {
  init: function() {
    ...
    this.appendStatementInput("vars")
        .setCheck(null);
    this.appendDummyInput()
        .appendField("STATEMENTS CANCION");
...
Blockly.Blocks['bloque_funcion'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["void", "VOID"],["int", "INT"], ["float", "FLOAT"], ["char", "CHAR"], ["bool", "BOOL"]]), "tipo")
        .appendField("PARAMS");
    this.appendValueInput("params")
        .setCheck(null);
    this.appendStatementInput("vars")
        .setCheck(null)
        .appendField("VARS FUNCION");
    this.appendStatementInput("funcs")
        .setCheck(null)
        .appendField("STATEMENTS FUNCION");
